...
export default {
    ...
    mounted () {
        document.getElementById("back-to-top").style.background = "url(" + this.url + ")"
        window.addEventListener("scroll", function () {
            if (window.pageYOffset > 500) {
                document.getElementById("back-to-top").style.top = '-200px'
            }
            else {
                document.getElementById("back-to-top").style.top = '-999px'
            }
        })
    }
}
